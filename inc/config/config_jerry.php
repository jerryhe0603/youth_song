...
# iMarketing 銀河數位行銷
define('_LOCAL_HOST', '172.16.1.229'); // localhost
define('_LOCAL_DB',   'youth_song');
define('_LOCAL_USER', 'robot');
define('_LOCAL_PASS', 'robot');

//Default
define('_MYSQL_HOST', '172.16.1.229'); // localhost
 ...
 * queue db *Required*
 */
define('_USER_HOST',	'172.16.1.229');
 ...
 */
defined('_SESSION_HOST')||define('_SESSION_HOST',	'172.16.1.229');
...
define ("_WEB_ADDRESS_TW", "youth_index.php?");//TW的網站位置
define ("_WEB_ADDRESS_CN", "youth_index.php?");//CN的網站位置
