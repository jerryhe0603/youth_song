...
define('_LOCAL_USER', 'ifind');
define('_LOCAL_PASS', 'ifind098');

//Default
define('_MYSQL_HOST', 'localhost'); // localhost
define('_MYSQL_DB',   'youth_song');
define('_MYSQL_USER', 'ifind');
define('_MYSQL_PASS', 'ifind098');

define('_USER_HOST',	'localhost');
define('_USER_DB',		'youth_song');
define('_USER_USER',	'ifind');
define('_USER_PASS',	'ifind098');
...
defined('_SESSION_USER')||define('_SESSION_USER',	'ifind');
defined('_SESSION_PASS')||define('_SESSION_PASS',	'ifind098');
