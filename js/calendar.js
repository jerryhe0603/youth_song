...
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "change to first day every week";
Calendar._TT["PREV_YEAR"] = "last year";
Calendar._TT["PREV_MONTH"] = "last month";
Calendar._TT["GO_TODAY"] = "select today";
Calendar._TT["NEXT_MONTH"] = "next month";
Calendar._TT["NEXT_YEAR"] = "next year";
Calendar._TT["SEL_DATE"] = "select date";
Calendar._TT["DRAG_TO_MOVE"] = "move";
Calendar._TT["PART_TODAY"] = " (today)";
Calendar._TT["MON_FIRST"] = "display Monday to first day";
Calendar._TT["SUN_FIRST"] = "display Sunday to first day";
