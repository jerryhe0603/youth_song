var ssb = {
  ...
  scrollbar : function (cont_id) {
    ...
    cont.ssb_onscroll = function () {
      this.ratio = (this.offsetHeight - 0.2 * this.sw) / this.scrollHeight;
  ...
  refresh : function () {
    for (var i = 0, N = ssb.N; i < N; i++) {
      ...
      o.sb.style.height = Math.ceil(Math.max(o.sw , o.ratio * o.offsetHeight )*8 + 1) + 'px';
    }
  },
  // arrow scrolling
...
window.onload = function() {
  ssb.scrollbar('pop-detail'); // scrollbar initialization
}
