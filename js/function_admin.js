...
function getTagSelector(layout_element,target_element,component_element,parent_tag_no){
	var url = "api.tag.php?target_element="+target_element+"&component_element="+component_element+"&layout_element="+layout_element+"&parent_tag_no="+parent_tag_no;
...
function getDocsFolderSelector(api_server,layout_element,parent_folder_no){
	var url = "http://"+api_server+"/admin/api.docsfolder.php?layout_element="+layout_element+"&parent_folder_no="+parent_folder_no;
